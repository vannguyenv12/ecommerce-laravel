        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function($query) {
                ...
                if ($query->status == 1) {
                    ...
                    <input type="checkbox" name="custom-switch-input" data-id="'.$query->id.'" class="custom-switch-input change-status" checked>
                    <span class="custom-switch-indicator"></span>
                  </label>';

                } else {
                    $button = '<label class="custom-switch">
                    <input type="checkbox" name="custom-switch-input" data-id="'.$query->id.'" class="custom-switch-input change-status">
                    <span class="custom-switch-indicator"></span>
                  </label>';
                }
                return $button;
            ...
            ->addColumn('show_at_home', function($query) {
                ...
                if ($query->show_at_home == 1) {
                    $button = '<label class="custom-switch">
                    <input type="checkbox" name="custom-switch-input" data-id="'.$query->id.'" class="custom-switch-input change-at-home-status" checked>
                    <span class="custom-switch-indicator"></span>
                  </label>';

                } else {
                    $button = '<label class="custom-switch">
                    <input type="checkbox" name="custom-switch-input" data-id="'.$query->id.'" class="custom-switch-input change-at-home-status">
                    <span class="custom-switch-indicator"></span>
                  </label>';
                }
                return $button;
