                            ...
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        {{session()->has('product_list_style') && session()->get('product_list_style') == 'grid' ? 'active' : ''}} {{!session()->has('product_list_style') ? 'show active' : ''}} list-view"
                                                        ...
                                                        @foreach ($product->variants as $variant)
                                                            <select class="d-none" name="variants_items[]">
                                                                @foreach ($variant->productVariantItems as $variantItem)
                                                                    <option {{$variantItem->is_default == 1 ? 'selected' : ''}} value="{{$variantItem->id}}">{{$variantItem->name}} (${{$variantItem->price}}) </option>
                                                                @endforeach
                                                            </select>
                                                        @endforeach
                                        ...
                                        <div class="col-xl-12">
                                            <div class="wsus__product_item wsus__list_view">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        <form class="shopping-cart-form" action="" class="mr-2">
                                                            <input type="hidden" name="product_id" value="{{$product->id}}">
                                                            @foreach ($product->variants as $variant)
                                                                <select class="d-none" name="variants_items[]">
                                                                    @foreach ($variant->productVariantItems as $variantItem)
                                                            ...
                                                            <button class="add_cart mr-2" style="margin-right: 12px;" type="submit">add to cart</button>
                                                        </form>
