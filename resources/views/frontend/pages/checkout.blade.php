                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                                ...
                                @if ($method->type === 'min_cost' && getCartTotal() >= $method->min_cost)
                                    <div class="form-check">
                                        <input class="form-check-input shipping_method" type="radio" name="exampleRadios" id="exampleRadios1"
                                            value="option1" value="{{$method->id}}" data-id="{{$method->cost}}">
                            ...
                            <a href="" class="common_btn" id="submitCheckoutForm">Place Order</a>
                        </div>
                    </div>
                </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            $('#submitCheckoutForm').on('click', function(e) {
                ...
                if ($('#shipping_method_id').val() == "") {
                    ...
                    toastr.error('You have to agree website term');
                }
                else {
                    $.ajax({
