    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown {{setActive(['admin.category.*', 'admin.sub-category.*', 'admin.child-category.*'])}}">
          ...
          'admin.products.*', 'admin.seller-products.*', 'admin.seller-pending-products.*'])}}">
          ...
          <li class="dropdown {{setActive(['admin.vendor-profile.*', 'admin.flash-sale.*', 'admin.vendor-profile.*', 'admin.coupons.*', 'admin.shipping-rule.*'])}}">
